    ...
    return (
      <div 
        ...
        className={`relative overflow-hidden transition-all duration-500 rounded-[28px] shadow-2xl border border-white/10 select-none
          ...
          bg-gradient-to-br from-denim-800 via-denim-900 to-black text-white p-4 sm:p-8
        `}
      ...
      >
        ...
        <div className="flex justify-between items-start mb-3 sm:mb-6 relative z-10">
          ...
          {isPro && (
            <div className="bg-white/5 backdrop-blur-md px-2 sm:px-3 py-0.5 sm:py-1 rounded-full border border-white/10 flex items-center gap-1 sm:gap-1.5 shadow-lg">
              <Sparkles size={8} className="text-amber-400 sm:size-3" />
              <span className="text-[5px] sm:text-[7px] font-black uppercase tracking-widest text-amber-100">PRO VERIFIED</span>
            </div>
          )}
        </div>
